...
class EmbeddedServer {
  ...
  Future<void> start() async {
    ...
    try {
      ...
      _running = true;  // FIX: Set BEFORE serve() blocks
      // shelf_io.serve blocks until server stops - run in fire-and-forget
      unawaited(shelf_io.serve(handler, _server!.address, _server!.port));
    } catch (e) {
      _running = false;
      rethrow;
    }
